...
class Visualizer:
    ...
    def __init__(self, petab_files: object, results_dict: dict):
        """This class is designed to plot and save the visualization data.
        input:
            petab_files: PEtabFileLoader - object containing the PEtab files:
             - yaml_file: str - path to the YAML file
        ...
        self.yaml_file = petab_files.yaml_file
        self.results_dict = results_dict
        self.visualization_df = petab_files.visualization_df
        self.observable_df = petab_files.observable_df
        self.measurement_df = petab_files.measurement_df
